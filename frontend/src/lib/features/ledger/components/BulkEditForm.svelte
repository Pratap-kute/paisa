  ...
  <div class="paisa-bulk-edit-controls flex flex-wrap items-end gap-3">
    ...
    {#if selectedOperation === "rename_account"}
      ...
      <div class="paisa-control-item is-expanded">
        <label class="paisa-control-label" for="old-account-select"
          >Old Account Name</label
        >
      ...
      <!-- New Account -->
      <div class="paisa-control-item is-expanded">
        <label class="paisa-control-label" for="new-account-input"
    ...
    <div class="paisa-bulk-edit-actions">
      <button
        ...
        onclick={(_e) =>
          dispatch("preview", { operation: selectedOperation, args: args })}
      >
