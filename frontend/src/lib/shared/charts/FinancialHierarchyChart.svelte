<script lang="ts">
import {
  buildFinancialHierarchyOption,
  type FinancialHierarchyChartData,
} from "$lib/shared/charts/echarts/hierarchy";
...
const option = $derived(
  buildFinancialHierarchyOption(data, { theme: tokenTheme }),
);
$effect(() => {
  $theme;
