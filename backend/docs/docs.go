    ...
    "paths": {
        ...
        "/insights": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Month period in YYYY-MM format (defaults to current month)",
                        "name": "period",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.InsightsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/investment/performance": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "current_fy, previous_fy, one_year, since_inception",
                        "name": "preset",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Exact investment account or ancestor",
                        "name": "accountPrefix",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Include boundary timeline",
                        "name": "timeline",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Include exact-account drivers",
                        "name": "drivers",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.InvestmentPerformance"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/prediction/merchant-rule": {
            "post": {
                ...
                "operationId": "upsertMerchantRule",
                "parameters": [
                    {
                        "description": "Merchant rule details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.MerchantRuleUpsertRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.MerchantRuleSaveResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/scenario/baseline": {
            "get": {
                ...
                "operationId": "getScenarioBaseline",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Projection months, 1–120 (default 60)",
                        "name": "horizonMonths",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ScenarioBaseline"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/scenario/evaluate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Absolute overrides; annual returns are ratios",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ScenarioRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ScenarioResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.InvestmentPerformance": {
            ...
            "properties": {
                ...
                "closingQuotes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PerformanceQuote"
                    }
                },
                "closingValue": {
                    "type": "number"
                ...
                "drivers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PerformanceDriver"
                    }
                },
                "endDate": {
                    "type": "string"
                ...
                "quality": {
                    "$ref": "#/definitions/dto.PerformanceQuality"
                },
                ...
                "timeline": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PerformancePoint"
                    }
                },
                "withdrawals": {
                    "type": "number"
        ...
        "dto.MerchantRuleSaveResponse": {
            ...
            "properties": {
                ...
                "rule": {
                    "$ref": "#/definitions/dto.MerchantRuleResponse"
                },
                "saved": {
                    "type": "boolean"
                }
        ...
        "dto.PerformanceQuality": {
            "type": "object",
            "properties": {
                "reasons": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PerformanceReason"
                    }
                },
                "status": {
                    "type": "string"
        ...
        "dto.ScenarioAssumptions": {
            ...
            "properties": {
                ...
                "scenarioAnnualInvestmentReturn": {
                    "type": "number"
                }
            }
        },
        "dto.ScenarioBaseline": {
            "type": "object",
            "properties": {
                "asOfDate": {
                    "type": "string"
                ...
                "monthlyExpenses": {
                    "$ref": "#/definitions/dto.ScenarioAssumption"
                },
                "monthlyIncome": {
                    "$ref": "#/definitions/dto.ScenarioAssumption"
                },
                ...
                "quality": {
                    "$ref": "#/definitions/dto.ScenarioQuality"
                },
                "startDate": {
                    "type": "string"
                },
                "staticNetWorthComponent": {
                    "type": "number",
                    "x-nullable": true
                }
            }
        ...
        "dto.ScenarioImpact": {
            ...
            "properties": {
                ...
                "endingInvestmentDelta": {
                    "type": "number"
                },
                "endingNetWorthDelta": {
                    "type": "number"
                },
                "investmentGrowthDelta": {
                    "type": "number"
                },
                "minimumCashDelta": {
                    "type": "number"
        ...
        "dto.ScenarioProjection": {
            ...
            "properties": {
                ...
                "points": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ScenarioPoint"
                    }
                },
                "startDate": {
                    "type": "string"
        ...
        "dto.ScenarioQuality": {
            ...
            "properties": {
                "reasons": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ScenarioReason"
                    }
                },
                "status": {
                    "type": "string"
        ...
        "dto.ScenarioRequest": {
            ...
            "properties": {
                ...
                "oneTimeEvents": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ScenarioEvent"
                    }
                },
                "scenarioAnnualInvestmentReturn": {
                    "type": "number",
        ...
        "dto.ScenarioResult": {
            ...
            "properties": {
                "assumptions": {
                    "$ref": "#/definitions/dto.ScenarioAssumptions"
                },
                "available": {
                    "type": "boolean"
                },
                "baseline": {
                    "allOf": [
                        {
                            "$ref": "#/definitions/dto.ScenarioProjection"
                        }
                    ],
                    "x-nullable": true
                },
                "impact": {
                    "allOf": [
                        {
                            "$ref": "#/definitions/dto.ScenarioImpact"
                        }
                    ],
                    "x-nullable": true
                },
